...
public interface GraphIfc<V> { //Thalia
	 ...
	 */
	public void addEdge(V u, V v); //Thalia

	/**
	 * Returns the set of all vertices in the graph.
	 * @return A set containing all vertices in the graph
	 */
	public Set<V> getVertices(); //Jordan
	 ...
	 */
	public List<V> getNeighbors(V v); //Thalia
	 ...
	 */
	public boolean containsVertex(V v); //Jordan
	 ...
	 * @throws IllegalArgumentException if either vertex does not occur in the graph
	 */
	public boolean edgeExists(V v, V u); //Thalia
